...
import lib.frcteam1678.bases.ServoMotorSubsystem.ServoHomingConfig;
import lib.frcteam1678.io.MotorIOTalonFX;
import lib.frcteam1678.io.MotorIOTalonFX.MotorIOTalonFXConfig;
import lib.frcteam1678.io.MotorIOTalonFXSim;
import lib.frcteam1678.sim.LinearSim;
import lib.frcteam1678.sim.LinearSim.LinearSimConstants;
...
public class ElevatorConstants {
    ...
    public static final Pose3d stage3Offset = new Pose3d(
                -0.0,
                0.0,
                0.0,
                new Rotation3d(BaseUnits.AngleUnit.zero(), BaseUnits.AngleUnit.zero(), Units.Degrees.of(90.0)));
	...
	public static LinearSimConstants getSimConstants() {
		...
		simConstants.motor = DCMotor.getKrakenX60Foc(2);
