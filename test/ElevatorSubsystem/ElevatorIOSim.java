...
import frc.robot.ElevatorNTParamsNT.ElevatorGearing;
...
public class ElevatorIOSim implements ElevatorIO {
    ...
    private final ProfiledPIDController controller =
            new ProfiledPIDController(
                    ElevatorGearing.kP.getValue(),
                    ElevatorGearing.kI.getValue(),
                    ElevatorGearing.kD.getValue(),
                    new Constraints(
    ...
    public void updateInputs(ElevatorIOInputs inputs) {
        for (int i = 0; i < Constants.LOOPER_DT / (1.0 / 1000.0); i++) {
            ...
            double feedforward = ElevatorGearing.kS.getValue() * Math.signum(simState.get(1)) +
                               ElevatorGearing.kV.getValue() * simState.get(1) +
                               ElevatorGearing.kA.getValue() * acceleration +
                               ElevatorGearing.kG.getValue();// gravity compensation
